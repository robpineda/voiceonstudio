  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-8 text-center">
      ...
      <header className="mb-16">
        <h1 className="text-5xl font-bold text-blue-900 mb-3">Voice Polisher</h1>
        <p className="text-xl text-gray-600">Analyze and polish your voice recordings effortlessly.</p>
      </header>
      ...
      <main className="w-full max-w-4xl">
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center mb-12">
           ...
           <div className="flex flex-col items-center md:items-end space-y-4">
             <p className="text-2xl font-medium text-gray-700">Record your own audio now</p>
             <Button
           ...
           <div className="flex flex-col items-center md:items-start space-y-4">
             <p className="text-2xl font-medium text-gray-700">Upload your own audio</p>
        ...
        <div className="w-full max-w-2xl mx-auto mb-12">
             <label htmlFor="scriptText" className="block text-lg font-medium text-gray-700 mb-2">Paste Script (Optional)</label>
             <Textarea
                 id="scriptText"
                 ...
                 value={scriptText}
             />
             <p className="text-sm text-gray-500 mt-2">Comparing your audio against a script can improve analysis accuracy.</p>
         </div>
        ...
        <Button
          ...
          disabled={!audioFile} // Disable if no audio file
        >
          Analyze Audio
        </Button>
